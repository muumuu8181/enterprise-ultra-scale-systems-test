...
from src.api.v1.noise import router as noise_router
from src.api.v1.lighting import router as lighting_router
# モデルをインポートしてmetadataに登録させる
import src.models.lighting_models
import src.models.noise_models
...
app.include_router(noise_router, prefix="/api/v1")
